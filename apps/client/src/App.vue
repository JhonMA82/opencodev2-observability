...
const formatEventType = (type: string) => {
  const names: Record<string, string> = {
    ...
    'session.execution.started': 'ExecutionStarted',
    'session.execution.succeeded': 'ExecutionSucceeded',
    'session.execution.failed': 'ExecutionFailed',
    'session.execution.interrupted': 'ExecutionInterrupted',
    'session.step.started': 'StepStarted',
    'session.step.ended': 'StepEnded',
    'session.step.failed': 'StepFailed',
    'session.retry.scheduled': 'RetryScheduled',
    'session.compaction.ended': 'CompactionEnded',
...
const getEventBadgeClass = (eventType: string) => {
  const classes: Record<string, string> = {
    ...
    'session.deleted': 'badge-session',
    'session.execution.started': 'badge-session',
    'session.execution.succeeded': 'badge-session',
    'session.execution.failed': 'badge-error',
    'session.execution.interrupted': 'badge-stop',
    'session.step.started': 'badge-session',
    'session.step.ended': 'badge-session',
    'session.step.failed': 'badge-error',
    'session.retry.scheduled': 'badge-stop',
    'session.compaction.ended': 'badge-session',
    'session.status': 'badge-session',
    'session.idle': 'badge-idle',
    'session.error': 'badge-error',
    'permission.replied': 'badge-message',
